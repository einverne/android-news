...
public class hot_place extends ListActivity  implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		handler = new Handler();
		//Button peopleButton = (Button) findViewById(R.id.people1);
		//Button divisionButton = (Button) findViewById(R.id.division1);
        ...
        ((PullToRefreshListView) getListView()).setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.setClass(hot_place.this, zhuanti.class);
				startActivity(intent);
				hot_place.this.finish();
			}
		});
        /*
        peopleButton.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(hot_place.this,hot_people.class);
				startActivity(intent);
				hot_place.this.finish();
			}
		});
		divisionButton.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(hot_place.this, hot_division.class);
				startActivity(intent);
				hot_place.this.finish();
			}
		});
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			Intent intent = new Intent();
			intent.setClass(hot_place.this, MainActivity.class);
			startActivity(intent);
			hot_place.this.finish();
