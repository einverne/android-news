...
public class ConnectWeb {
	...
	static public boolean getJobOfUser(DBAdapter dbadapter, String username,
		...
		try {
			...
			Log.d(TAG, "���Jobnameһ����������:" + String.valueOf(count));
			JSONArray docs = result.getJSONArray("docs");
			// ѭ����ר����ȡ��ÿ��ר����н���
			Log.d(TAG, "���Jobһ���ж��ٸ�ר��" + String.valueOf(docs.length()));
	 ...
	 *            2020121106
	 * @param dateT
	 *            2020121106x x��ʾ���಻�� 2020121106 20201211
	 * @return ���������������
	 */
	...
	static public int getzuijinxinwen(DBAdapter dbadapter) {
		/*
		 * ��ݸ�ʽ�� result clusters others cluster words count
